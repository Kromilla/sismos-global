...
export const REGIONS: Region[] = [
  {
    ...
    blurb: 'Transformante Pacífico–Norteamérica: falla Imperial y sistema del Golfo.',
  },
  {
    id: 'mx-guerrero',
    ...
    blurb: 'Subducción de Cocos bajo Norteamérica. Aloja la brecha sísmica de Guerrero.',
  },
  {
    id: 'mx-jalisco',
    ...
    blurb: 'Bloque Jalisco y placa Rivera; origen del sismo de Michoacán 1985 (M8.0).',
  },
  {
    id: 'ca-guate',
    ...
    blurb: 'Subducción de Cocos más la falla de Motagua (límite Norteamérica–Caribe).',
  },
  {
    id: 'ca-nicacr',
    ...
    blurb: 'Fosa Mesoamericana y arco volcánico; sismicidad somera muy frecuente.',
  },
  {
    id: 'ca-panama',
    name: 'Panamá–Chocó',
    ...
    blurb: 'Choque del bloque de Panamá contra Sudamérica; cinturón deformado del Norte.',
  },
  {
    id: 'co-caribe',
  ...
  },
  {
    ...
    blurb: 'Enjambre profundo (~150 km) único en el mundo por su tasa constante.',
  },
  {
    id: 'co-pacifico',
  ...
  },
  {
    ...
    blurb: 'Subducción de Nazca frente a Esmeraldas–Manabí y fallas interandinas.',
  },
  {
    id: 'pe-norte',
    ...
    blurb: 'Subducción plana (flat slab) frente a Lima; recurrencia histórica alta.',
  },
  {
    id: 'pe-sur',
    name: 'Perú sur–Arica',
  ...
  },
  {
    ...
    blurb: 'Brecha de Atacama; Iquique 2014 (M8.2) liberó solo parte del déficit.',
  },
  {
    id: 'cl-centro',
    name: 'Chile central',
    ...
    blurb: 'Valparaíso–Santiago: 1906, 1985 y déficit acumulado desde entonces.',
  },
  {
    id: 'cl-sur',
    name: 'Chile sur',
...
export const WORLD_REGIONS: Region[] = [
  {
    ...
    blurb: 'Subducción del Pacífico bajo Norteamérica; el M9.2 de 1964 salió de aquí.',
  },
  {
    id: 'na-cascadia',
    name: 'Cascadia',
    ...
    blurb: 'Subducción silenciosa de Juan de Fuca; último megaterremoto en 1700.',
  },
  {
    id: 'na-california',
    name: 'California',
    ...
    blurb: 'Falla de San Andrés: transformante entre el Pacífico y Norteamérica.',
  },
  {
    id: 'pa-kamchatka',
  ...
  },
  {
    ...
    blurb: 'La fosa más profunda del planeta; sismicidad intensa y lejos de costa.',
  },
  {
    id: 'as-sumatra',
    name: 'Sumatra',
    ...
    blurb: 'Ruptura de 2004 (M9.1) y la falla de Sumatra en el interior de la isla.',
  },
  {
    id: 'as-java',
  ...
  },
  {
    ...
    blurb: 'Choque de Australia con el Pacífico; de las tasas más altas del mundo.',
  },
  {
    id: 'oc-vanuatu',
  ...
  },
  {
    ...
    blurb: 'La subducción más rápida del planeta y el slab más profundo que se conoce.',
  },
  {
    id: 'oc-nz',
    name: 'Nueva Zelanda',
  ...
  },
  {
    ...
    blurb: 'Colisión India–Eurasia. Gorkha 2015 (M7.8) liberó solo parte del déficit.',
  },
  {
    id: 'as-hindukush',
    name: 'Hindu Kush',
    ...
    blurb: 'Enjambre profundo a unos 200 km, comparable al nido de Bucaramanga.',
  },
  {
    id: 'as-tianshan',
    ...
    blurb: 'Deformación intracontinental a 2.000 km de cualquier límite de placa.',
  },
  {
    id: 'as-zagros',
    name: 'Irán y Zagros',
    ...
    blurb: 'Convergencia Arabia–Eurasia; sismos someros bajo construcción frágil.',
  },
  {
    id: 'eu-anatolia',
  ...
  },
  {
    ...
    blurb: 'Apeninos y arco calabrés: sismos moderados sobre patrimonio frágil.',
  },
  {
    id: 'eu-caucaso',
    name: 'Cáucaso',
